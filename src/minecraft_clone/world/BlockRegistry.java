...
public class BlockRegistry {
    ...
    static {
        ...
        register(BlockType.WOOD_PLANKS,   new BlockProperties("Wood planks", true, false,  new int[] {4, 0}, new int[] {4, 0}, new int[] {4, 0}));
//        register(BlockType.SAPLING,   new BlockProperties("Wood planks", true, false,  new int[] {4, 0}, new int[] {4, 0}, new int[] {4, 0}));
        register(BlockType.BEDROCK,   new BlockProperties("Bedrock", true, false,  new int[] {1, 1}, new int[] {1, 1}, new int[] {1, 1}));
//        register(BlockType.WATER_FLOWING,   new BlockProperties("Wood planks", true, false,  new int[] {4, 0}, new int[] {4, 0}, new int[] {4, 0}));
//        register(BlockType.WATER_STILL,   new BlockProperties("Wood planks", true, false,  new int[] {4, 0}, new int[] {4, 0}, new int[] {4, 0}));
//        register(BlockType.LAVA_FLOWING,   new BlockProperties("Wood planks", true, false,  new int[] {4, 0}, new int[] {4, 0}, new int[] {4, 0}));
//        register(BlockType.LAVA_STILL,   new BlockProperties("Wood planks", true, false,  new int[] {4, 0}, new int[] {4, 0}, new int[] {4, 0}));
...
//        register(BlockType.BED_BLOCK,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.POWERED_RAIL,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.DETECTOR_RAIL,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
        register(BlockType.STICKY_PISTON,   new BlockProperties("Sticky piston", true, false,  new int[] {10, 6}, new int[] {12, 6}, new int[] {13, 6}));
//        register(BlockType.COBWEB,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.TALL_GRASS,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.DEAD_SHRUB,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
        register(BlockType.PISTON,   new BlockProperties("Piston", true, false,  new int[] {11, 6}, new int[] {12, 6}, new int[] {13, 6}));
//        register(BlockType.PISTON_EXTENSION,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
        register(BlockType.WHITE_WOOL,   new BlockProperties("White wool", true, false,  new int[] {0, 4}, new int[] {0, 4}, new int[] {0, 4}));
//        register(BlockType.BLOCK_MOVED_BY_PISTON,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.DANDELION,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.ROSE,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.BROWN_MUSHROOM,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.RED_MUSHROOM,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
...
//        register(BlockType.DOUBLE_STONE_SLAB,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.STONE_SLAB,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
...
//        register(BlockType.TORCH,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.FIRE,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.MONSTER_SPAWNER,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.OAK_WOOD_STAIRS,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.CHEST,   new BlockProperties("Chest", true, false,  new int[] {5, 2}, new int[] {5, 2}, new int[] {5, 2}));
//        register(BlockType.REDSTONE_WIRE,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
...
//        register(BlockType.WHEAT_CROPS,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
...
//        register(BlockType.BURNING_FURNACE,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.SIGN_POST,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.OAK_DOOR_BLOCK,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.LADDER,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.RAIL,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.COBBLESTONE_STAIRS,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.WALL_SIGN,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.LEVER,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.STONE_PRESSURE_PLATE,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.IRON_DOOR_BLOCK,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.WOODEN_PRESSURE_PLATE,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
        register(BlockType.REDSTONE_ORE,   new BlockProperties("Redstone ore", true, false,  new int[] {3, 3}, new int[] {3, 3}, new int[] {3, 3}));
//        register(BlockType.GLOWING_REDSTONE_ORE,   new BlockProperties("Note block", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.REDSTONE_TORCH_OFF,   new BlockProperties("Redstone ore", true, false,  new int[] {3, 3}, new int[] {3, 3}, new int[] {3, 3}));
//        register(BlockType.REDSTONE_TORCH_ON,   new BlockProperties("Redstone ore", true, false,  new int[] {3, 3}, new int[] {3, 3}, new int[] {3, 3}));
//        register(BlockType.STONE_BUTTON,   new BlockProperties("Redstone ore", true, false,  new int[] {3, 3}, new int[] {3, 3}, new int[] {3, 3}));
//        register(BlockType.SNOW,   new BlockProperties("Snow", true, false,  new int[] {2, 4}, new int[] {2, 4}, new int[] {2, 4}));
        ...
        register(BlockType.SNOW_BLOCK,   new BlockProperties("Snow block", true, false,  new int[] {2, 4}, new int[] {2, 4}, new int[] {2, 4}));
...
//        register(BlockType.SUGAR_CANE,   new BlockProperties("Clay", true, false,  new int[] {8, 4}, new int[] {8, 4}, new int[] {8, 4}));
        register(BlockType.JUKEBOX,   new BlockProperties("Jukebox", true, false,  new int[] {11, 4}, new int[] {10, 4}, new int[] {10, 4}));
//        register(BlockType.FENCE,   new BlockProperties("Clay", true, false,  new int[] {8, 4}, new int[] {8, 4}, new int[] {8, 4}));
...
//        register(BlockType.PORTAL,   new BlockProperties("Clay", true, false,  new int[] {8, 4}, new int[] {8, 4}, new int[] {8, 4}));
...
//        register(BlockType.CAKE,   new BlockProperties("Clay", true, false,  new int[] {8, 4}, new int[] {8, 4}, new int[] {8, 4}));
//        register(BlockType.REDSTONE_REPEATER_OFF,   new BlockProperties("Clay", true, false,  new int[] {8, 4}, new int[] {8, 4}, new int[] {8, 4}));
//        register(BlockType.REDSTONE_REPEATER_ON,   new BlockProperties("Clay", true, false,  new int[] {8, 4}, new int[] {8, 4}, new int[] {8, 4}));
    }
